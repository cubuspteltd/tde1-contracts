...
contract SimpleToken is UpgradeableToken, Ownable {
  ...
  */
  ...
  function SimpleToken(string _name, string _symbol, uint _totalSupply, uint _decimals) UpgradeableToken(msg.sender) {
    name = _name;
    symbol = _symbol;
    decimals = _decimals;
